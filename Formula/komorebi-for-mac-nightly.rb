class KomorebiForMacNightly < Formula
  ...
  url "https://api.github.com/repos/KomoCorp/komorebi-for-mac/releases/assets/428241884",
      headers: [
        "Accept: application/octet-stream",
        "X-GitHub-Api-Version: 2022-11-28",
        "Authorization: bearer #{ENV.fetch("HOMEBREW_GITHUB_API_TOKEN")}",
      ]
  version "0.1.0-nightly-2026-05-23-18:26:58"
  sha256 "7e18235a13e5969214d44706b6e2c5776faf6b4b3aedba9c74cef2e229293ba1"
