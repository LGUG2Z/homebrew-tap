class KomorebiForMacNightly < Formula
  ...
  url "https://api.github.com/repos/KomoCorp/komorebi-for-mac/releases/assets/410843696",
      headers: [
        "Accept: application/octet-stream",
        "X-GitHub-Api-Version: 2022-11-28",
        "Authorization: bearer #{ENV.fetch("HOMEBREW_GITHUB_API_TOKEN")}",
      ]
  version "0.1.0-nightly-2026-05-02-18:17:47"
  sha256 "d4cbf044b458e062502e5b171d53e8ec679e8eb8309f87a10d0cdbef400a49b2"
